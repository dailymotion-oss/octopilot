...
import (
	...
	"github.com/dailymotion/octopilot/internal/git"
	"github.com/dailymotion/octopilot/repository"
...
func defaultCommitFooter() string {
	...
	footer.WriteString(fmt.Sprintf("This is an automatic commit generated by OctoPilot %v", buildVersion))
